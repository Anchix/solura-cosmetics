import { d as useNavigate, r as reactExports, j as jsxRuntimeExports, S as Skeleton, b as ue } from "./index-BYwbnXHo.js";
import { u as useCartStore, L as Layout, M as MapPin } from "./Layout-DTgLeLmj.js";
import { u as useAuthStore, B as Button } from "./authStore-bVvk2SIb.js";
...
import { u as useCreateOrder } from "./useOrders-Cf1TPwy3.js";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-primary font-semibold bg-primary/10 px-2 py-0.5 rounded-full", children: "No extra charge" }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            paymentMethod === "cod" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-xs text-muted-foreground bg-muted/40 rounded-xl p-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "A ₹",
                COD_CHARGE,
                " handling charge is added for Cash on Delivery orders. Pay the total amount to the delivery partner."
              ] })
            ] })
          ] }),
