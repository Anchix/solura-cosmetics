import { r as reactExports, j as jsxRuntimeExports, c as cn, L as Link, d as useNavigate } from "./index-BrjEsxOs.js";
import { c as createLucideIcon, A as create, E as persist, a as useComposedRefs$1, l as Primitive, k as Presence, g as createContextScope, b as composeEventHandlers, o as useCallbackRef, p as useLayoutEffect2, X, B as Button, u as useAuthStore, x as Sheet, y as SheetTrigger, M as Menu, z as SheetContent } from "./authStore-DllIseEP.js";
import { u as useDirection, c as clamp$1, S as Separator } from "./separator-rMUPFFHz.js";
/**
  ...
  persist(
    (set, get) => ({
      ...
      addItem: (product, quantity, variantId, variantName) => {
        ...
        set((state) => {
          ...
          const existing = state.items.find(
            (item) => variantId ? item.productId === product.id && item.variantId === variantId : item.productId === product.id && !item.variantId
          );
          if (existing) {
            return {
      ...
      removeItem: (productId, variantId) => {
        set((state) => ({
          items: state.items.filter(
            (item) => variantId ? !(item.productId === productId && item.variantId === variantId) : !(item.productId === productId && !item.variantId)
          )
        }));
      },
      updateQuantity: (productId, quantity, variantId) => {
        ...
        set((state) => ({
          items: state.items.map((item) => {
            const match = variantId ? item.productId === productId && item.variantId === variantId : item.productId === productId && !item.variantId;
...
const FAQ_RESPONSES = {
  "track order": "To track your order, go to My Account → Order History. You'll find your order status there. For further help, email contact@soluracosmo.com with your order ID.",
  "product info": "Solura Cosmetics offers Skincare, Makeup, and Haircare products — all formulated with Ayurvedic ingredients and clinically tested. Which category would you like to know more about?",
  shipping: "We offer free shipping on orders above ₹999 across India. Standard delivery takes 3–7 business days. Express options may be available at checkout.",
  returns: "We accept returns within 7 days of delivery for unused, sealed products. To initiate a return, email contact@soluracosmo.com with your order ID and reason.",
  payment: "We accept Razorpay (cards, UPI, netbanking) and Cash on Delivery. COD orders have a ₹40 convenience charge. Online payments are free.",
  "cash on delivery": "Yes, we offer Cash on Delivery (COD) with a ₹40 convenience fee. Online payments via Razorpay have no extra charge.",
  cod: "Yes, we offer Cash on Delivery (COD) with a ₹40 convenience fee. Online payments via Razorpay have no extra charge.",
  cancel: "Orders can be cancelled before they are shipped. Go to My Account → Order History and click Cancel. For shipped orders, please raise a return request.",
  discount: "We run regular promotions! Subscribe to our newsletter or follow us for exclusive discount codes and early access to sales.",
  ingredients: "All Solura products use natural, Ayurvedic ingredients — saffron, kumkumadi, sandalwood, and more — no harmful chemicals. Cruelty-free and dermatologist tested.",
  skincare: "Our Skincare range includes serums, moisturizers, face oils, and cleansers — crafted with ancient South Indian botanicals for radiant, healthy skin.",
  makeup: "Our Makeup collection features foundations, lipsticks, kajal, and more — long-wearing formulas with skin-loving ingredients.",
  haircare: "Our Haircare line includes oils, shampoos, and treatments powered by Ayurvedic herbs to strengthen and nourish hair from root to tip."
};
...
function ChatbotWidget() {
  ...
  const [messages, setMessages] = reactExports.useState(loadSession);
  ...
  const sendMessage = reactExports.useCallback(
    async (text) => {
      ...
      const botText = faqAnswer ?? "Thank you for your question! For personalized help, please email us at contact@soluracosmo.com. We're happy to assist you with your beauty journey! 😊";
      const botMsg = {
        id: `b-${Date.now()}`,
        role: "bot",
        text: botText,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-rose px-4 py-3 flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-9 h-9 rounded-full bg-white/25 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-5 h-5 text-white" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-white text-sm leading-tight", children: "Solura Support" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs font-body", children: "Beauty Assistant • Online" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          msg.role === "bot" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-7 h-7 rounded-full gradient-rose flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-white" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `max-w-[78%] px-3 py-2 rounded-2xl text-sm font-body leading-relaxed break-words ${msg.role === "user" ? "bg-primary text-primary-foreground rounded-tr-sm" : "bg-card border border-border text-foreground shadow-soft rounded-tl-sm"}`,
                              children: msg.text
                            }
                          )
                        ]
                    ...
                    loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-7 h-7 rounded-full gradient-rose flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-white" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-1 shadow-soft", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                    ...
                    messages.length === 1 && !loading && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: "flex flex-wrap gap-2 mt-1",
                        "data-ocid": "chat-quick-replies",
                        children: QUICK_REPLIES.map((qr) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border bg-card p-3 flex items-end gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    ref: textareaRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.button,
          {
            ...
            children: [
              ...
              !open && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 w-3 h-3 rounded-full bg-secondary border-2 border-card animate-pulse" })
            ]
          }
        )
      ]
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-card border-t border-border mt-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/8 border-b border-border py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold text-foreground", children: "Stay Radiant." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Subscribe for exclusive offers and beauty tips." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "form",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold text-foreground", children: "Solura" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground tracking-widest uppercase ml-2", children: "Cosmetics" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-xs", children: "Reveal Your Natural Glow. Premium beauty rooted in Ayurvedic wisdom, crafted for modern Indian skin." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "184, South Manthai Street, Pallapatti, Karur, Tamil Nadu 639205" })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-body font-semibold text-foreground mb-4 text-sm uppercase tracking-wider", children: "Shop" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: SHOP_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: link.href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-body font-semibold text-foreground mb-4 text-sm uppercase tracking-wider", children: "Help" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: HELP_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: link.href,
            className: "text-sm text-muted-foreground hover:text-primary transition-colors",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-body font-semibold text-foreground mb-4 text-sm uppercase tracking-wider", children: "Account" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: ACCOUNT_ROUTER_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: link.href,
            className: "text-sm text-muted-foreground hover:text-primary transition-colors",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-muted/30 py-6 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground uppercase tracking-widest mb-4 font-medium", children: "Certified & Trusted" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-3", children: CERTIFICATIONS.map(({ label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground tracking-wide", children: label })
          ]
        },
        label
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "GST: 33AFUFS3776C1ZM" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:inline", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              rel: "noopener noreferrer",
              className: "hover:text-primary transition-colors",
              children: "BrandHype Solutions"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Accepted payments:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 border border-border rounded text-xs bg-muted/40", children: "Visa" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 border border-border rounded text-xs bg-muted/40", children: "Mastercard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 border border-border rounded text-xs bg-muted/40", children: "UPI" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 border border-border rounded text-xs bg-muted/40", children: "COD" })
        ] })
      ] })
    ] })
  ] });
...
function Layout({ children, fullWidth = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground text-xs text-center py-2 px-4 font-body tracking-wide", children: "🌿 Free shipping on orders above ₹999 | Designed in India, Inspired by Tradition" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: `sticky top-0 z-50 bg-card border-b border-border transition-smooth ${scrolled ? "shadow-soft" : ""}`,
        "data-ocid": "header-nav",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "Solura" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body hidden sm:block tracking-widest uppercase mt-1", children: "Cosmetics" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/auth", "data-ocid": "header-account", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
                size: "icon",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", className: "relative", "data-ocid": "header-cart", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "ghost",
                size: "icon",
                ...
                children: [
                  ...
                  itemCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 h-5 w-5 rounded-full bg-primary text-primary-foreground text-xs flex items-center justify-center font-bold", children: itemCount > 9 ? "9+" : itemCount })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileOpen, onOpenChange: setMobileOpen, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetContent, { side: "right", className: "w-[300px] bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 mt-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-xl font-bold mb-4 text-foreground", children: "Solura Cosmetics" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    onClick: () => setMobileOpen(false),
                    children: isLoggedIn ? "My Account" : "Login / Register"
                  }
                )
              ] }) })
            ] })
