import { e as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, f as clsx, R as React, i as invariant, j as jsxRuntimeExports, L as Link, h as useSharedActor } from "./index-BrjEsxOs.js";
import { S as ShoppingCart, A as AdminLayout } from "./AdminLayout-DG7YXN1p.js";
import { S as StatusBadge } from "./Badge-CBfUvLbY.js";
import { S as StatCardSkeleton } from "./LoadingSkeleton-CZPIkWFD.js";
import { c as createLucideIcon, u as useAuthStore, B as Button } from "./authStore-DllIseEP.js";
import { d as useAdminStats, e as useAdminOrders } from "./useOrders-BV2CJZ35.js";
import { f as useAdminProducts } from "./useProducts-Bm2yLUIN.js";
import { C as Clock } from "./clock-Sub80nnx.js";
import { P as Package } from "./package-B6LtfKzX.js";
import { U as Users } from "./users-C7PwCdQz.js";
import { A as ArrowRight } from "./arrow-right-DzuYoa1W.js";
...
function AdminLoginGate() {
  ...
  reactExports.useEffect(() => {
    ...
    let cancelled = false;
    setVerifying(true);
    actor.adminVerifyToken(adminToken).then((valid) => {
      if (cancelled) return;
      setVerifying(false);
      if (valid) {
  ...
  if (verifying) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Verifying session…" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-8 w-full max-w-sm shadow-elevated", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Admin Access" }),
      !isActorReady && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2 flex items-center justify-center gap-1.5", children: [
...
function AdminDashboard() {
  ...
  if (!isAdmin || !adminToken) return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLoginGate, {});
  const recentOrders = (orders == null ? void 0 : orders.slice(0, 10)) ?? [];
  const statCards = [
    {
      label: "Total Orders",
      value: stats == null ? void 0 : stats.totalOrders,
      icon: ShoppingCart,
      color: "text-primary",
      bg: "bg-primary/8"
    },
    ...
    },
    {
      ...
      value: stats == null ? void 0 : stats.pendingOrders,
      icon: Clock,
    ...
    },
    {
      ...
      value: (products == null ? void 0 : products.length) ?? (stats == null ? void 0 : stats.totalProducts),
      icon: Package,
  ...
  const chartData = stats == null ? void 0 : stats.last7Days.map((d2) => ({
    date: new Date(d2.date).toLocaleDateString("en-IN", {
      day: "numeric",
      month: "short"
    }),
    orders: d2.orders,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { title: "Dashboard", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4", children: isLoading ? [1, 2, 3, 4, 5].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCardSkeleton, {}, k2)) : statCards.map(({ label, value, icon: Icon, color: color2, bg }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground leading-tight", children: value ?? "—" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-semibold text-foreground", children: "Last 7 Days Performance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Order count and revenue trend" })
      ] }) }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72 bg-muted/30 rounded-lg animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: chartData,
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Legend,
              {
                formatter: (val) => val === "revenue" ? "Revenue (₹)" : "Orders",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "Recent Orders" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: recentOrders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground", children: "Order ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground hidden md:table-cell", children: "Customer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground hidden lg:table-cell", children: "Date" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-2.5 text-xs font-medium text-muted-foreground", children: "Total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground", children: "Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-xs font-medium text-muted-foreground hidden xl:table-cell", children: "Payment" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: recentOrders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden md:table-cell text-sm", children: order.shippingAddress.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden xl:table-cell text-muted-foreground capitalize text-xs", children: order.paymentMethod === "razorpay" ? "Online" : "COD" })
            ]
          },
          order.id
        )) })
    ...
    ].map(({ to, label, sub, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: sub })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" })
        ]
      }
    ) }, to)) })
  ] }) });
