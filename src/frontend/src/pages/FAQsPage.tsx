      ...
      <div className="bg-primary/5 border-b border-border py-14 px-4">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Everything you need to know about Solura Cosmetics — orders,
            delivery, returns, and our products.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto max-w-3xl space-y-8">
          ...
          <div className="bg-primary/5 rounded-2xl border border-primary/20 p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4 text-sm">
              Our support team is happy to help with any question not covered
              above.
            </p>
            <a
